			...
			<div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tambah IT Support</h4><hr>
                            </div>
                            <div class="content">
                                <form method="POST" action="file/insert_it_support.php">
                                    <div class="row">
                                        <div class="col-md-5">
                        ...
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                  ...
                                  <h4 class="title">Data IT Support<br />
...
$query1 = mysql_query("SELECT * FROM it_support ORDER BY nama_it_support ASC");
$no=1;
while ($k = mysql_fetch_array($query1)) {
?>																	
 										<tr>
                                        	<td><?php echo $no; ?></td>
                                        	<td><?php echo $k['nik_it_support']; ?></td>
                                        	<td><?php echo $k['nama_it_support']; ?></td>
                                        	<td><?php echo $k['email']; ?></td>
                                        	<td><?php echo $k['no_telp']; ?></td>
											<td>
											<a href="file/hapus_it_support.php?id=<?php echo $k['nik_it_support'];?>" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delMember"><span class="ti-trash"></span> Hapus</a>
											</td>
