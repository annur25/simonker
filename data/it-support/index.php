...
if (ISSET($_SESSION['its']))
{
	...
	$query = mysql_query("Select * from it_support where nik_it_support='$username'");
	...
	-->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
					...
					<li class="<?php if ($page=='karyawan'){echo 'active';}?>">
						<a href="?page=karyawan">
							<i class="ti-user"></i>
							<p>Karyawan</p>
						</a>
					</li>
					<li class="<?php if ($page=='it-support'){echo 'active';}?>">
						<a href="?page=it-support">
							<i class="ti-user"></i>
							<p>IT Support</p>
						</a>
					</li>
					<li class="<?php if ($page=='kerusakan'){echo 'active';}?>">
						<a href="?page=kerusakan">
							...
							<p><span class="badge pull-right" style="margin-top:5px;">
							<?php
								$query1 = mysql_query("SELECT * FROM monitoring_kerusakan where status='0'");
								$jml1 = mysql_num_rows($query1);
								echo $jml1;
							?>
							</span>
							Laporan Kerusakan</p>
					...
					<li class="<?php if ($page=='perbaikan'){echo 'active';}?>">
						<a href="?page=perbaikan">
							...
							<p><span class="badge pull-right" style="margin-top:5px;">
							<?php
								$query2 = mysql_query("SELECT * FROM monitoring_kerusakan where status='1'");
								$jml2 = mysql_num_rows($query2);
								echo $jml2;
							?>
							</span>Sedang Diperbaiki</p>
						</a>
					</li>
            ...
            <div class="container-fluid">
				...
				<li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <i class="ti-user"></i>                             
									<p>Hello, <b><u><?php echo $k['nama_it_support']; ?></u></b></p>
									<b class="caret"></b>
                              </a>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	...
            	message: "Welcome to <b>SIMONKER</b> - Anda telah berhasil masuk sebagai administrator IT Support."
