...
if ((empty($bln)) and (empty($thn))) {
	$query1 = mysql_query("SELECT * FROM monitoring_kerusakan a, karyawan b where a.nik_karyawan=b.nik_karyawan and status='0' ORDER by tgl_time_kerusakan DESC");
} else {
	$query1 = mysql_query("SELECT * FROM monitoring_kerusakan a, karyawan b where a.nik_karyawan=b.nik_karyawan and month(tgl_time_kerusakan)='$bln' and year(tgl_time_kerusakan)='$thn' and status='0' ORDER by tgl_time_kerusakan DESC");
}
$no=1;
